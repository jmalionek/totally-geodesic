...
#SBATCH --nice=10000
#SBATCH --time=7-00:00
#SBATCH --output=/data/keeling/a/chaeryn2/totally-geodesic/result_cover
#SBATCH --error=/data/keeling/a/chaeryn2/totally_geodesic_error/result_cover
...
def sort_results():
    ...
    #        if file in os.listdir('/data/keeling/a/chaeryn2/totally_geodesic/'):
        with open('/data/keeling/a/chaeryn2/totally_geodesic/' + file, 'rb') as f:
            info = pickle.load(f)
        i = file.removeprefix('totally_geodesic_info_cover')
    ...
    manifold_data.to_csv('/data/keeling/a/chaeryn2/totally-geodesic/result_cover.csv', index=False)
